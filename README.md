# Unidad 4 - Taller 1: Conectividad Multibase de Datos con Pandas
...
### 2. Abrir el Cuaderno y seleccionar el Kernel
1. Abre este directorio en **VS Code**.
2. Abre el archivo **`Taller 1.ipynb`**.
3. En la esquina superior derecha de tu pantalla, hacer clic en **"Select Kernel"** (o "Seleccionar Kernel") y eligir tu entorno de **Python 3.10+**.

### 3. Instalar las dependencias de Python
La primera celda del cuaderno contiene el comando para instalar todas las dependencias necesarias en tu entorno activo:
...
2. ** Conexión a Oracle (Modo Thin):** Configurada en modo Thin (sin necesidad de instalar Oracle Instant Client en la máquina local).
